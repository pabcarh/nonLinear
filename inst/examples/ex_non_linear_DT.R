...
#non_linear_DT(x,y,Error,yl,xl,yyl,xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,dir=dir,variable="DT") # development rate
#non_linear_DT(x,y,Error,yl,xl,yyl,xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,SEmodel=0.23632013752966,DFF=28,dir=dir,variable="DT") # senescense
#non_linear_DT(x,y,Error,yl,xl,yyl,xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,SEmodel=0.280539574188242,dir=dir,variable="DT") # Oviposition time using the original SE of the model
#non_linear_DT(x,y,Error,yl,xl,yyl,xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,SEmodel=0.23632013752966,DFF=28,dir=dir,variable="DT") # Oviposition time using SE of senescense model
#non_linear_DT(x,y,yl=yl,xl=xl,yyl=yyl,xxl=xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,SEmodel=0.534779270479086,dir=dir,variable="Fec") # Fecundity option 1
#non_linear_DT(x,y,yl=yl,xl=xl,yyl=yyl,xxl=xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,dir=dir,variable="Fec",modelling=TRUE) # Fecundity option 2
#y<-exp(y)
#non_linear_DT(x,y,yl=yl,xl=xl,yyl=yyl,xxl=xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,dir=dir,variable="Other",modelling=TRUE) # Fecundity option 3
...
non_linear_DT(x,y,yl=yl,xl=xl,yyl=yyl,xxl=xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,SEmodel=0.534779270479086,dir=dir,variable="Other",height=8,cex.lab=1.5,TITLE="Fecundity") # Fecundity option 6 - new function
...
non_linear_DT(x,y,Error=Error,yl=yl,xl=xl,yyl=yyl,xxl=xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,dir=dir,variable="Other")
#non_linear_DT(x,y,Error,yl,xl,yyl,xxl,ylab=ylab,Fyx=Fyx,Ival=Ival,dir=dir,modelling=TRUE)
